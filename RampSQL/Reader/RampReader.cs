...
namespace RampSQL.Reader
{
    public class RampReader : IDisposable
    {
        ...
        public object this[RampColumn column] { get => reader[column.SUCN]; }
        ...
        public bool GetBoolean(RampColumn column) => Convert.ToBoolean(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public byte GetByte(RampColumn column) => Convert.ToByte(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public char GetChar(RampColumn column) => Convert.ToChar(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public DateTime GetDateTime(RampColumn column) => Convert.ToDateTime(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public decimal GetDecimal(RampColumn column) => Convert.ToDecimal(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public double GetDouble(RampColumn column) => Convert.ToDouble(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public float GetFloat(RampColumn column) => Convert.ToSingle(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public Guid GetGuid(RampColumn column) => Guid.Parse(Convert.ToString(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]));
        ...
        public short GetInt16(RampColumn column) => Convert.ToInt16(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public int GetInt32(RampColumn column) => Convert.ToInt32(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public long GetInt64(RampColumn column) => Convert.ToInt64(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public string GetString(RampColumn column) => Convert.ToString(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN]);
        ...
        public T Get<T>(RampColumn column)
        {
            try
            {
                return (T)Convert.ChangeType(reader[column.SUCN] == DBNull.Value ? null : reader[column.SUCN], column.GetType());
            }
            catch
            {
                return default(T);
