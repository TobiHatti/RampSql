...
namespace RampSql.Reader
{
    public class RampReader
    {
        ...
        public bool GetBoolean(RampColumn column) => Convert.ToBoolean(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public byte GetByte(RampColumn column) => Convert.ToByte(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public char GetChar(RampColumn column) => Convert.ToChar(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public DateTime GetDateTime(RampColumn column) => Convert.ToDateTime(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public decimal GetDecimal(RampColumn column) => Convert.ToDecimal(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public double GetDouble(RampColumn column) => Convert.ToDouble(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public float GetFloat(RampColumn column) => Convert.ToSingle(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public Guid GetGuid(RampColumn column) => Guid.Parse(Convert.ToString(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]));
        ...
        public short GetInt16(RampColumn column) => Convert.ToInt16(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public int GetInt32(RampColumn column) => Convert.ToInt32(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public long GetInt64(RampColumn column) => Convert.ToInt64(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public string GetString(RampColumn column) => Convert.ToString(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN]);
        ...
        public T Get<T>(RampColumn column)
        {
            try
            {
                return (T)Convert.ChangeType(reader[column.UCN] == DBNull.Value ? null : reader[column.UCN], column.GetType());
            }
            catch
            {
                return default(T);
